    ...
    return (
        <main className="bg-white text-black " data-testid="home-page">
            ...
            <div className="container mx-auto px-4 py-8   max-w-4xl">
                <h1 className="text-3xl font-bold text-brand mb-4">{content.title}</h1>
                ...
                <div className="prose prose-sm max-w-none">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-brand mb-4">{content.controller.title}</h2>
                        <p>{content.controller.content}</p>
                        <p className="mt-2">{content.controller.email}</p>
                    </section>

                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-brand mb-4">{content.dataCollected.title}</h2>
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-brand mb-4">{content.purpose.title}</h2>
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-brand mb-4">{content.rights.title}</h2>
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-brand mb-4">{content.cookies.title}</h2>
                        <p>{content.cookies.content}</p>
                    </section>

                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-brand mb-4">{content.security.title}</h2>
                        <p>{content.security.content}</p>
                    </section>

                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-brand mb-4">{content.analytics.title}</h2>
